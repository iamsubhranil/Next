...
const char *core_source =
    ...
    "                throw RuntimeException(\"Array size should be a positive "
    "integer!\")\n"
    "            }\n"
    "            size = 0\n"
    ...
    "                // if not reassigned\n"
    "                items = __next_array_reallocate(items, capacity, capacity "
    "* 2)\n"
    "                capacity = capacity * 2\n"
    "            }\n"
    ...
    "                throw RuntimeException(\"Array index should be an "
    "integer!\")\n"
    "            }\n"
    ...
    "                    } else {\n"
    "                        throw RuntimeException(\"Method hash() not found "
    "in the object!\")\n"
    "                    }\n"
    "                }\n"
    "                ret finalhash\n"
    ...
    "                throw RuntimeException(\"Range upto must be an "
    "integer!\")\n"
    "            }\n"
    "            from = 0\n"
    "            to = x\n"
    ...
    "        new(x, y) {\n"
    "            if(!is_same_type(x, 2) or !x.is_int()) {\n"
    "                throw RuntimeException(\"Range from must be an "
    "integer!\")\n"
    "            }\n"
    ...
    "                throw RuntimeException(\"Range step must be an "
    "integer!\")\n"
    "            }\n"
    "            from = x\n"
    "            to = y\n"
